...
import { MarkReadResponseDto, NotificationResponseDto } from "./dto/notification.dto";
...
export class NotificationsController {
  ...
  markRead(@Session() session: UserSession, @Param("id") id: string): Promise<MarkReadResponseDto> {
