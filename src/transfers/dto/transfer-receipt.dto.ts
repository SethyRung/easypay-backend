...
export class TransferReceiptDto {
  ...
  @ApiProperty({
    example: 130.0,
    description: 'Amount transferred (major units)',
  })
  amount: number;
  ...
  @ApiProperty({
    example: 132.0,
    description: 'Total debit from sender (major units)',
  })
  totalDebit: number;
  ...
  @ApiProperty({
    description: 'Recipient balance before transfer (minor units)',
  })
  recipientBalanceBeforeMinor: number;

  @ApiProperty({
    description: 'Recipient balance after transfer (minor units)',
  })
